...
const portfolioItems = [
  { id: 2, title: 'Bohemian Sunset', category: 'Outdoor', image: '/images/2.jpg', size: 'small' },
  { id: 3, title: 'Golden Gala', category: 'Corporate', image: '/images/3.jpg', size: 'small' },
  { id: 5, title: 'Floral Symphony', category: 'Wedding', image: '/images/5.jpg', size: 'small' },
  { id: 6, title: 'Intimate Candlelight', category: 'Private', image: '/images/6.jpg', size: 'large' },
  { id: 7, title: 'Crystal Reception', category: 'Wedding', image: '/images/7.jpg', size: 'small' },
  { id: 8, title: 'Rustic Barn Setup', category: 'Wedding', image: '/images/8.jpg', size: 'small' },
  { id: 9, title: 'Urban Loft Party', category: 'Corporate', image: '/images/9.jpg', size: 'wide' },
  { id: 10, title: 'Summer Poolside', category: 'Outdoor', image: '/images/10.jpg', size: 'large' },
  { id: 11, title: 'Elegant Banquet', category: 'Wedding', image: '/images/11.jpg', size: 'small' },
  { id: 12, title: 'Kids Theme Park', category: 'Birthday', image: '/images/12.jpg', size: 'small' },
  { id: 14, title: 'Luxury Yacht Event', category: 'Private', image: '/images/14.jpg', size: 'small' },
  { id: 15, title: 'Vintage Car Display', category: 'Corporate', image: '/images/15.jpg', size: 'large' },
  { id: 16, title: 'Mountain Retreat', category: 'Outdoor', image: '/images/16.jpg', size: 'small' },
  { id: 17, title: 'Fairytale Castle', category: 'Wedding', image: '/images/17.jpg', size: 'small' },
  { id: 18, title: 'Neon Disco Night', category: 'Birthday', image: '/images/18.jpg', size: 'wide' },
  { id: 19, title: 'Grand Conference', category: 'Corporate', image: '/images/19.jpg', size: 'small' },
  { id: 20, title: 'Terrace Dining', category: 'Private', image: '/images/20.jpg', size: 'large' },
  { id: 21, title: 'Jungle Canopy', category: 'Outdoor', image: '/images/21.jpg', size: 'small' },
  { id: 22, title: 'Desert Oasis', category: 'Wedding', image: '/images/22.jpg', size: 'small' },
  { id: 23, title: 'Space Odyssey', category: 'Birthday', image: '/images/23.jpg', size: 'wide' },
  { id: 24, title: 'Art Gallery Opening', category: 'Corporate', image: '/images/24.jpg', size: 'small' },
  { id: 25, title: 'Masquerade Ball', category: 'Private', image: '/images/25.jpg', size: 'large' },
  { id: 26, title: 'Rooftop Bar', category: 'Outdoor', image: '/images/26.jpg', size: 'small' },
  { id: 27, title: 'Cottage Ceremony', category: 'Wedding', image: '/images/27.jpg', size: 'small' },
  { id: 28, title: 'Superhero Bash', category: 'Birthday', image: '/images/28.jpg', size: 'wide' },
  { id: 29, title: 'Product Launch', category: 'Corporate', image: '/images/29.jpg', size: 'small' },
  { id: 30, title: 'Vegas Theme Night', category: 'Private', image: '/images/30.jpg', size: 'large' },
  { id: 31, title: 'Vineyard Tasting', category: 'Outdoor', image: '/images/31.jpg', size: 'small' },
  { id: 32, title: 'Winter Wonderland', category: 'Wedding', image: '/images/32.jpg', size: 'small' },
  { id: 33, title: 'Pirate Adventure', category: 'Birthday', image: '/images/33.jpg', size: 'wide' },
  { id: 34, title: 'Team Building Workshop', category: 'Corporate', image: '/images/34.jpg', size: 'small' },
  { id: 35, title: 'Cocktail Party', category: 'Private', image: '/images/35.jpg', size: 'large' },
  { id: 36, title: 'Meadow Picnic', category: 'Outdoor', image: '/images/36.jpg', size: 'small' },
  { id: 37, title: 'Historic Mansion', category: 'Wedding', image: '/images/37.jpg', size: 'small' },
  { id: 38, title: 'Carnival Festival', category: 'Birthday', image: '/images/38.jpg', size: 'wide' },
  { id: 39, title: 'Annual Dinner', category: 'Corporate', image: '/images/39.jpg', size: 'small' },
  { id: 41, title: 'Botanical Garden', category: 'Outdoor', image: '/images/41.jpg', size: 'small' },
  { id: 42, title: 'Lakeside Ceremony', category: 'Wedding', image: '/images/42.jpg', size: 'small' },
  { id: 43, title: 'Mad Hatter Tea Party', category: 'Birthday', image: '/images/43.jpg', size: 'wide' },
  { id: 44, title: 'Exhibition Booth', category: 'Corporate', image: '/images/44.jpg', size: 'small' },
  { id: 45, title: 'Silent Auction', category: 'Private', image: '/images/45.jpg', size: 'large' },
  { id: 46, title: 'Glamping Setup', category: 'Outdoor', image: '/images/46.jpg', size: 'small' },
  { id: 47, title: 'Modern Industrial', category: 'Wedding', image: '/images/47.jpg', size: 'small' },
  { id: 48, title: 'Hollywood Red Carpet', category: 'Birthday', image: '/images/48.jpg', size: 'wide' },
  { id: 49, title: 'Awards Night', category: 'Corporate', image: '/images/49.jpg', size: 'small' },
  { id: 50, title: 'Themed Dinner', category: 'Private', image: '/images/50.jpg', size: 'large' },
  { id: 51, title: 'Hot Air Balloon Ride', category: 'Outdoor', image: '/images/51.jpg', size: 'small' },
  { id: 52, title: 'Zen Garden', category: 'Wedding', image: '/images/52.jpg', size: 'small' },
  { id: 53, title: 'Fairy Forest', category: 'Birthday', image: '/images/53.jpg', size: 'wide' },
  { id: 54, title: 'Networking Mixer', category: 'Corporate', image: '/images/54.jpg', size: 'small' },
  { id: 56, title: 'Ski Lodge', category: 'Outdoor', image: '/images/56.jpg', size: 'small' },
  { id: 57, title: 'Cathedral Ceremony', category: 'Wedding', image: '/images/57.jpg', size: 'small' },
  { id: 58, title: 'Under the Sea', category: 'Birthday', image: '/images/58.jpg', size: 'wide' },
  { id: 59, title: 'Charity Fundraiser', category: 'Corporate', image: '/images/59.jpg', size: 'small' },
  { id: 60, title: 'Exclusive Launch Party', category: 'Private', image: '/images/60.jpg', size: 'large' },
  { id: 61, title: 'Exclusive Launch Party', category: 'Private', image: '/images/61.jpg', size: 'large' },
  { id: 62, title: 'Exclusive Launch Party', category: 'Private', image: '/images/62.jpg', size: 'large' },
  { id: 63, title: 'Exclusive Launch Party', category: 'Private', image: '/images/63.jpg', size: 'large' },
  { id: 64, title: 'Exclusive Launch Party', category: 'Private', image: '/images/64.jpg', size: 'large' }
];
